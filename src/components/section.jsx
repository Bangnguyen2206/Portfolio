...
const Section = () => {
  return (
    <section className="py-6 dark:bg-gray-800 dark:text-gray-100 px-10">
      <TrackVisibility>
        {({ isVisible }) => (
          <div
            ...
            <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
              <div className="flex space-x-6">
                ...
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">ReactJS | NuxtJS</h4>
              ...
              <div className="flex space-x-6">
                ...
                />
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">Vue | Prisma | Nuxt</h4>
                  <p className="text-sm text-white">Frontend Development</p>
              ...
              <div className="flex space-x-6">
                ...
                />
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">NodeJS | MongDB</h4>
                  <p className="text-sm text-white">Backend Development</p>
              ...
              <div className="flex space-x-6">
                ...
                />
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">GraphQL</h4>
                  <p className="text-sm text-white">Query language for your API</p>
              ...
              <div className="flex space-x-6">
                ...
                />
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">Microservices | Eng</h4>
              ...
              <div className="flex space-x-6">
                ...
                />
                <div className="flex-col hidden lg:flex">
                  <h4 className="text-xl text-white font-semibold">Git | VSCode | Figma</h4>
                  <p className="text-sm text-white">Developmet Tools</p>
